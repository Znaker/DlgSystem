...
public:
	...
	static EVisibility GetEdgeDataVisibility()
	{
		return GetDefault<UDlgSystemSettings>()->bShowEdgeData ? EVisibility::Visible : EVisibility::Hidden;
	}
